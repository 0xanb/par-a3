...
by scripts/scene.sh which directly publishes /par/active_mode ( in
 for the firmware-mismatch context). The /buttons input./leds output paths were dropped because the rosbot_ros snap on
...
class SupervisorConfig:
 ...
 # override at runtime (operator default 0.3 rad/s on cautious tier).
