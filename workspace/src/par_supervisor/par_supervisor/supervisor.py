...
Post pivot: the legacy /buttons subscriber, /leds publisher,.mode-B CPU policy were removed. Neither /buttons nor /leds is exposed by
...
then idle forever.md for the full context.
...
class SupervisorNode(Node):
 ...
 self.declare_parameter("spin_overrun_factor", 1.055)
