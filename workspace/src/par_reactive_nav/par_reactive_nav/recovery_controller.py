...
# Pure-function predicates extracted from the _on_intent for
...
def should_escalate_trapped(consecutive_recoveries: int,
 ...
 Captures the 4-walls-trap edge case where H1 ToF zeros both axes. the FSM cycles indefinitely without producing motion.
 """
...
class RecoveryController(Node):
 ...
 # 2-mode pivot : reactive recovery is part of "Mode A".
