...
class PerceptionFusion(Node):
    def __init__(self) -> None:
        ...
        # rear-left chassis edge, observed evening). These self-
        ...
        # 2-mode pivot post-: perception_fusion runs under "Mode A".
    ...
    def _depth_to_polar(self, depth: np.ndarray) -> np.ndarray:
        ...
        # bins 0..N/4 ∪ 3N/4..N (camera-forward = polar 0), while LIDAR was
        ...
        # only depth could detect. Diagnosed in the diag run.
