...
class Arbiter(Node):
 ...
 # deadlocked the tilt FSM. See I-NN / M-NN.
 ...
 # and the rear-halo branch was dead code at runtime. T-03 audit found
 ...
 rear reading available; SafetyLayer treats NaN as "no data". falls back to LIDAR-only rear coverage.
 """
