...
Algorithm dispatch:
 nd_hybrid → nd_planner + recovery_controller (the production)
 ...
 vfh_plus → vfh_planner + recovery_controller (validated baseline; )
...
def generate_launch_description:
 ...
 "recovery_controller, production), 'nd_only' "
 "(ND classifier without recovery FSM, reproduces "
